        ...
        <form method="POST" action="">
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="text" name="nomeCompleto" id="campo-nomeCompleto" required maxlength="250" minlength="7" disabled value="{{$usuario['nomeCompleto']}}">
                </div>
                ...
                <div class="controlCampo">
                    ...
                    <input type="date" name="dataNasc" id="campo-dataNasc" required disabled value="{{$usuario['dataNasc']}}">
                </div>
            </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="email" name="email" id="campo-emailCadastro" required disabled value="{{$usuario['email']}}">
                </div>
                
                <div class="controlCampo">
                    <label for="campo-senhaCadastro" id="campoLabel">Senha</label>
                    <input type="text" name="password" id="campo-senhaCadastro" required minlength="8" disabled value="********">
                </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="tel" pattern="([0-9]{2}) [0-9]{5}-[0-9]{4}" name="telefone" id="campo-telefone" required disabled value="{{$usuario['telefone']}}">
                </div>

                <div class="controlCampo">
                    <label for="campo-qtMorador" id="campoLabel">Quantidade de moradores</label>
                    <input type="number" name="qtMorador" id="campo-qtMorador" required disabled value="{{$usuario['qtMorador']}}">
                </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="text" name="cep" id="campo-cep" required disabled value="{{$usuario['cep']}}">
                </div>

                <div class="controlCampo">
                    <label for="campo-estado" id="campoLabel">Estado</label>
                    <input type="text" name="estado" id="campo-estado" required disabled value="{{$usuario['estado']}}">
                </div>
            </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="text" name="cidade" id="campo-cidade" required disabled value="{{$usuario['cidade']}}">
                </div>
            </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="text" name="bairro" id="campo-bairro" required disabled value="{{$usuario['bairro']}}">
                </div>
            </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <input type="text" name="rua" id="campo-rua" required disabled value="{{$usuario['rua']}}">
                </div>

                <div class="controlCampo">
                    <label for="campo-numeroDaCasa" id="campoLabel">Número da casa</label>
                    <input type="text" name="numeroDaCasa" id="campo-numeroDaCasa" disabled value="{{$usuario['numeroDaCasa']}}">
                </div>
            </div>
            ...
            <div class="linha">
                <div class="controlCampo">
                    ...
                    <textarea cols="100" rows="10" name="referencias" id="campo-referencias" disabled>{{$usuario['referencias']}}</textarea>
                </div>
            </div>
